...
import 'personalplan_model.dart';
export 'personalplan_model.dart';

class PersonalplanWidget extends StatefulWidget {
  const PersonalplanWidget({Key? key}) : super(key: key);

  @override
  _PersonalplanWidgetState createState() => _PersonalplanWidgetState();
}

class _PersonalplanWidgetState extends State<PersonalplanWidget> {
  late PersonalplanModel _model;
